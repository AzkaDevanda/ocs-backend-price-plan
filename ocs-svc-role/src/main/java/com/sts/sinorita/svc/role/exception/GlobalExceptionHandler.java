package com.sts.sinorita.svc.role.exception;
...
import com.sts.sinorita.svc.role.utils.ValidationException;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<CustomeResponse> handleResponseStatusException(ResponseStatusException e) {
    return ResponseEntity.status(e.getStatusCode())
        .body(new CustomeResponse(e.getStatusCode().value(), e.getReason(), null));
  }
  ...
  private ResponseEntity<Map<String, Object>> internalServerErrorResponse() {
    Map<String, Object> response = new LinkedHashMap<>();
