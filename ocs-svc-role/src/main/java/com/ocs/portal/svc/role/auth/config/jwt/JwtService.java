package com.ocs.portal.svc.role.auth.config.jwt;
...
public class JwtService {
  ...
  public String generateToken(UserDetails userDetails, List<String> roleName) {
  ...
  private Key getSignInKey() {
    ...
    public String generateRefreshToken(String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 24 * 60 * 60 * 1000L)) // 1 hari
