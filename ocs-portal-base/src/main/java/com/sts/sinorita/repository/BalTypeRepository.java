...
import com.sts.sinorita.dto.request.BalTypeNameDto;
import com.sts.sinorita.entity.BalType;
...
public interface BalTypeRepository extends JpaRepository<BalType, Integer> {
    @Query("SELECT new com.sts.sinorita.dto.request.BalTypeNameDto(b.balTypeId, b.balTypeName) FROM BalType b ORDER BY b.balTypeName asc ")
    List<BalTypeNameDto> findBalTypeList();
