...
import com.sts.sinorita.entity.embeddable.PromotionTParamValId;

@Entity
@Table(name = "PROMOTION_T_PARAM_VAL", schema = "STS")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class PromotionTParamVal implements Serializable {

  @EmbeddedId
  private PromotionTParamValId id;
  ...
  @Column(name = "QUOTE_FLAG", length = 1)
