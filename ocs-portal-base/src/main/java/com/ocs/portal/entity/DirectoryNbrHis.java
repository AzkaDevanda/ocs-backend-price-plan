...
@Setter
@Entity
@Table(name = "DIRECTORY_NBR_HIS")
@NoArgsConstructor
public class DirectoryNbrHis implements Serializable {

    @Id
    @Column(name = "DIRECTORY_NBR_HIS_ID", nullable = false)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "directory_nbr_his_seq_gen")
    @SequenceGenerator(name = "directory_nbr_his_seq_gen", sequenceName = "DIRECTORY_NBR_HIS_ID_SEQ", allocationSize = 1)
    private Long directoryNbrHisId;

    @Column(name = "DIRECTORY_NBR_ID")
