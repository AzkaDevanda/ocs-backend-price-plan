...
import com.sts.sinorita.priceplan.PricePlanTypeService;
import com.sts.sinorita.priceplan.PricePlanService;
import com.sts.sinorita.priceplan.ServTypeService;
...
public class PricePlanController {
  ...
  public ResponseEntity<BaseResponseDto> getAllPricePlanType() {
    // log.info("::Request getAllType :: {}", new Gson().toJson(new
    // PricePlanTypeDto()));
  ...
  public ResponseEntity<BaseResponseDto> createPricePlan(@Valid @RequestBody PricePlanRequestDto pricePlanRequestDto) {
    // log.info("::Request createPricePlan :: {} ",
    // localDateAdapter.gsonConfig().toJson(pricePlanRequestDto));
